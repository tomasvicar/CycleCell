...
#        
#        
#        fake_fake_qpi=fake_fake_qpi[0,0,:,:].data.cpu().numpy()
#        fake_fake_qpi=(fake_fake_qpi+0.5)
#        name=name_qpi[0]
#        tmp=name.split('\\')
#        imsave(fol + '/ff' + tmp[-1],fake_fake_qpi)
#            
#        fake_fake_dapi=fake_fake_dapi[0,0,:,:].data.cpu().numpy()
#        fake_fake_dapi=(fake_fake_dapi+0.5)
#        name=name_dapi[0]
#        tmp=name.split('\\')
#        imsave(fol + '/ff' + tmp[-1],fake_fake_dapi)        
#    
#    
#    
#    
...
#fol='../l22_01_last'
#
#best_model_qpi2dapi='../l22_01/unet_qpi2dapi_5000_0.001_valid_loss0.001977381.pt'
#best_model_dapi2qpi='../l22_01/unet_dapi2qpi_5000_0.001_valid_loss0.001977381.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
#fol='../l22_1_last'
#
#best_model_qpi2dapi='../l22_1/unet_qpi2dapi_5000_0.001_valid_loss0.001288339.pt'
#best_model_dapi2qpi='../l22_1/unet_dapi2qpi_5000_0.001_valid_loss0.001288339.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
#fol='../l22_10_last'
#
#best_model_qpi2dapi='../l22_10/unet_qpi2dapi_5000_0.001_valid_loss0.004997795.pt'
#best_model_dapi2qpi='../l22_10/unet_dapi2qpi_5000_0.001_valid_loss0.004997795.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
#fol='../l22_100_last'
#
#best_model_qpi2dapi='../l22_100/unet_qpi2dapi_5000_0.001_valid_loss0.0009943742.pt'
#best_model_dapi2qpi='../l22_100/unet_dapi2qpi_5000_0.001_valid_loss0.0009943742.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
#
#
#fol='../l22_100_alltrain_last'
#
#best_model_qpi2dapi='../l22_100_alltrain/unet_qpi2dapi_5000_0.001_valid_loss0.0010927654.pt'
#best_model_dapi2qpi='../l22_100_alltrain/unet_dapi2qpi_5000_0.001_valid_loss0.0010927654.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
#
#
#fol='../l22_10_alltrain_last'
#
#best_model_qpi2dapi='../l22_10_alltrain/unet_qpi2dapi_5000_0.001_valid_loss0.0012661109.pt'
#best_model_dapi2qpi='../l22_10_alltrain/unet_dapi2qpi_5000_0.001_valid_loss0.0012661109.pt'
#
#try:
#    os.mkdir(fol)
#except:
...
fol='../l22_1_alltrain_last'

best_model_qpi2dapi='../l22_1_alltrain/unet_qpi2dapi_5000_0.001_valid_loss0.0011912892.pt'
best_model_dapi2qpi='../l22_1_alltrain/unet_dapi2qpi_5000_0.001_valid_loss0.0011912892.pt'
...
fol='../l22_01_alltrain_last'

best_model_qpi2dapi='../l22_01_alltrain/unet_qpi2dapi_5000_0.001_valid_loss0.00082286546.pt'
best_model_dapi2qpi='../l22_01_alltrain/unet_dapi2qpi_5000_0.001_valid_loss0.00082286546.pt'
...
best_model_qpi2dapi='../l22_u/unet_qpi2dapi_5000_0.001_valid_loss0.00041207767.pt'
best_model_dapi2qpi='../l22_u/unet_dapi2qpi_5000_0.001_valid_loss0.00041207767.pt'
...
best_model_qpi2dapi='../l2_u/unet_qpi2dapi_5000_0.001_valid_loss0.0129991425.pt'
best_model_dapi2qpi='../l2_u/unet_dapi2qpi_5000_0.001_valid_loss0.0129991425.pt'
